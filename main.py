...
def main():
	...
	for cycle in range(5):
		...
		val.append((sum(optimumRewards) - sum(randomRewards))/sum(randomRewards))
...
def learn(qBuilder,cycle):
	...
	for j in range(numOfPasses):
		for i in range(1, NUM_TRAINING_SETS + 1):
			...
			qBuilder.learnFromDataQLearning(data, num_iters=((cycle+1)*20))
		pass
	return
